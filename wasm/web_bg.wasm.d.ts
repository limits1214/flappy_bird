...
export const ffi_greet_to_rust: () => void;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbb21dc2b41601c21: (a: number, b: number) => void;
export const closure13690_externref_shim: (a: number, b: number, c: any) => void;
export const closure13695_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h66948b23ed43f3e0: (a: number, b: number) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6ee6ce748c3a0bb8: (a: number, b: number) => void;
export const closure53802_externref_shim: (a: number, b: number, c: any) => void;
