...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h612038bc04dc2cf3: (a: number, b: number) => void;
export const closure13690_externref_shim: (a: number, b: number, c: any) => void;
export const closure13700_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3d64e2646b1d1e87: (a: number, b: number) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4edf5232b8344c28: (a: number, b: number) => void;
export const closure53805_externref_shim: (a: number, b: number, c: any) => void;
